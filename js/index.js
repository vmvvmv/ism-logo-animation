...
for( obj of ismLogos ) {
	...
	container.append('<svg id="'+obj.id+'" class="' + 'ism-logo' + '" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1000 90" width="100%" height="100%" preserveAspectRatio="none" shape-rendering="geometricPrecision"> <polyline id="ISM-M" shape-rendering="geometricPrecision" vector-effect="non-scaling-stroke" points="377.5 87 377.5 6 683.5 87 994 6 994.5 87" /> <path id="ISM-S" vector-effect="non-scaling-stroke" d="M22.5,6c30.87,54.24,61.74,81,97,81,30,0,47.34-16.88,73-42.5,28.29-28.29,52.81-38.26,75-38.5,33.18-.36,66,27.53,99.5,81"> </path> <polyline id="ISM-I" vector-effect="non-scaling-stroke" points="5.5 87 5.5 45.5 5.5 6" /> </svg> ');
...
function initISMLogo() {
	...
	ismLogo.expand = function (t) {
		...
		}, t * 1.2, mina.easeinout);

		
	}

	ismLogo.glow = function () {
		...
		for( obj of ismLogos ) { 
			...
			window['ismLogo'].I = window[obj.key].I;

		}	

		

		Snap.animate( 0, 6, function( v ) { 
